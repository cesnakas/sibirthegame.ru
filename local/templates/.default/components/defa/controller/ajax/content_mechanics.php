...
$arVideo = Tools\Iblock::getElement([
    'FILTER' => ['IBLOCK_ID' => Tools\Iblock::getIdByCode('values', 'ref'), 'AC`TIVE' => 'Y', 'CODE' => 'video_mechanics',],
    'ID' => 'CODE',
...
$sVideo = trim($arVideo['PROPERTIES']['VALUES']['VALUE'][0]);

$arResult = [
    'title' => $sTitle,
    'descr' => $sDesc,
    'video' => $sVideo,
    'mechanics_list' => array_values(array_map(function($arItem) {
        return [
